        ...
        while True:
            ...
            if not isread:
                ...
                for (x,y,w,h) in faces:
                    ...
                    vector_img = vector_img - mean_vector)/np.linalg.norm((vector_img - mean_vector)
                    y = dot(PCA_matrix.transpose(),(vector_img - mean_vector))

                    img_class = face_reg.image_classifier(y,trained_data)
